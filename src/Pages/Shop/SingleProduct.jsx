...
const SingleProduct = () => {
  ...
  return (
    <div className=" relative  mt-20 w-full mx-w-screen-xl  mx-auto  flex flex-col  items-start  px-10 mdg:px-20   ">
      <Breadcrumbs />
      ...
      <div className="w-full pb-20 pt-10 flex flex-row items-start gap-20 border-b border-disableOverlay2">
        {/* right Section */}
        ...
        <div className="w-full flex flex-col items-start">
          {/* hashtag */}
          <div className="flex flex-wrap w-full gap-x-5 pb-10">
            {/* item */}
            <motion.a href="" whileTap={{scale:0.95}} className="border  border-solid border-disableOverlay rounded-xl text-headingColor text-xl px-5 py-3  font-medium relative  after:absolute after:w-8 after:h-7 after:bg-white after:right-4 after:-top-4 after:rounded-full">
...
/>
          ...
          {/* assets */}
          <div className="flex w-full flex-wrap py-7">
            {/* item assets */}
            <div className="flex  gap-x-2 border-l border-solid border-disableOverlay2 px-5">
              ...
              <p className="text-disableUnique font-semibold text-xl">
                + 1787 دانشجو
              </p>
            </div>
          ...
          <div className="w-full flex flex-col items-start pt-10">
            <div className="flex items-start flex-col w-full">
              ...
              <div className="flex w-full gap-10 flex-wrap pt-12">
         ...
         پشتیبانی روزانه
                ...
                <figure className="flex flex-col   justify-start items-center px-10 py-3 border border-solid rounded-secondary  border-disableOverlay2  h-150  w-150 transition-default group hover:border-secondary">
                  ...
                  <figcaption className="w-full flex flex-col pt-5">
                    <span className="text-2xl  font-medium text-green-600">2 ساعت</span>
                    <span className="text-disableOverlay text-xl whitespace-nowrap text-center font-medium">
         مشاوره رایگان 
                    </span>
                  </figcaption>
      ...
      <div className="flex flex-col w-full items-start py-20">
        <div className="flex  gap-x-7">
          <motion.button
            whileTap={{ scale: 0.9 }}
            className={`px-7 py-4 text-xl text-disableUnique font-semibold border border-solid border-disable rounded-full ${
        ...
        <div className="w-full mt-16 flex flex-row min-h-screen items-start gap-20">
          <aside className="w-4/12 sticky top-24 ">
            <ul className="w-full flex flex-col py-10 items-start gap-y-7 p-10">
              <li className="flex   cursor-pointer">
                ...
                >
                  ...
                  {/* icon */}
                  <p className="text-[14px] text-headingColor font-semibold mr-2  transition-default group-[.active]:text-secondary">
                    معرفی محصول
                  </p>
                </ScrollLink>
              </li>
          ...
          <main className="w-full">
            ...
            {activeTab === 1 && (
              <div className="flex flex-col w-full">
                <figure
                  id="introduction"
                  className="w-full flex flex-col items-start px-10 pb-20 pt-10  border-b border-disableOverlay2"
                >
            ...
            {activeTab === 2 && (
              <div className="flex flex-col items-start">
                ...
                <div className="flex gap-x-7 pb-16 w-full items-start">
                  <div className="px-7 py-4 rounded-secondary border border-solid w-ful flex justify-between cursor-pointer">
                    <input
                      type="text"
                      readOnly
                      className="text-2xl font-medium text-disableUnique"
